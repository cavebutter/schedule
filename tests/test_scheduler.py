...
class TestGroupsThree:
    ...
    #  Tests that the function returns the correct list of match pairings when given valid inputs.
    def test_valid_inputs(self):
        ...
        expected_result = [('team1', 'team2'), ('team2', 'team1'), ('team3', 'team4'), ('team4', 'team3')]
    ...
    #  Tests that the function returns the correct list of match pairings when there is only one team at each level.
    def test_one_team_per_level(self):
        # Arrange
        teams = {
            'level1': ['team1'],
            'level2': ['team2']
    ...
    #  Tests that the function returns the correct list of match pairings when there are multiple teams at each level.
    def test_multiple_teams_per_level(self):
        # Arrange
        teams = {
            'level1': ['team1', 'team2', 'team3'],
            'level2': ['team4', 'team5']
        }
        matchups = {
            'level1': 2,
        ...
        expected_result = [('team1', 'team2'), ('team2', 'team1'), ('team1', 'team3'), ('team3', 'team1'), ('team2', 'team3'), ('team3', 'team2'), ('team4', 'team5'), ('team5', 'team4')]
    ...
    #  Tests that the function returns an empty list when given an empty dictionary of teams and matchups.
    ...
    #  Tests that the function handles correctly when given a dictionary of teams and matchups with an odd number of teams and matches.
    def test_odd_number_of_teams_and_matches(self):
        # Arrange
        teams = {
            'level1': ['team1', 'team2', 'team3'],
            'level2': ['team4', 'team5']
        ...
        expected_result = [('team1', 'team2'), ('team2', 'team1'), ('team1', 'team3'), ('team3', 'team1'), ('team2', 'team3'), ('team3', 'team2'), ('team1', 'team2'), ('team2', 'team1'), ('team1', 'team3'), ('team3', 'team1'), ('team2', 'team3'), ('team3', 'team2'), ('team4', 'team5'), ('team5', 'team4'), ('team4', 'team5'), ('team5', 'team4')]
